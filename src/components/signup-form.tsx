        ...
        <div className="mx-auto w-full max-w-md">
          ...
          <div className="flex flex-col gap-2 text-center md:text-left mb-8">
            ...
            <p className="text-sm text-zinc-500">
              Enter your details below to get started with Vitals
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            <FieldGroup>
              ...
              <Field data-invalid={!!fieldErrors.name}>
                <FieldLabel htmlFor="name" className="text-xs font-semibold text-zinc-500 uppercase tracking-wider">Full Name</FieldLabel>
                <InputGroup>
                  <InputGroupInput
                    id="name"
                    type="text"
              ...
              <Field data-invalid={!!fieldErrors.password}>
                <FieldLabel htmlFor="password" className="text-xs font-semibold text-zinc-500 uppercase tracking-wider">Create password</FieldLabel>
                <InputGroup>
                  <InputGroupInput
                    id="password"
